cmd_arch/x86/kernel/crash_dump_32.o := gcc -m32 -Wp,-MD,arch/x86/kernel/.crash_dump_32.o.d  -nostdinc -isystem /usr/lib/gcc/i486-linux-gnu/4.2.4/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -O2 -pipe -msoft-float -mregparm=3 -freg-struct-return -mpreferred-stack-boundary=2  -march=i586 -mtune=generic -ffreestanding -maccumulate-outgoing-args   -Iinclude/asm-x86/mach-default -fomit-frame-pointer -g  -fno-stack-protector -Wdeclaration-after-statement -Wno-pointer-sign     -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(crash_dump_32)"  -D"KBUILD_MODNAME=KBUILD_STR(crash_dump_32)" -c -o arch/x86/kernel/.tmp_crash_dump_32.o arch/x86/kernel/crash_dump_32.c

deps_arch/x86/kernel/crash_dump_32.o := \
...
arch/x86/kernel/crash_dump_32.o: $(deps_arch/x86/kernel/crash_dump_32.o)
